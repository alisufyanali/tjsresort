                            ...
                            <div class="col-lg-12 col-xl-3">
                                <div class="user-body">
                                    <div class="p-20 text-center">
                                        <a href="{{ route('employee.email.compose') }}"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="btn btn-success p-1"
                                                                        href="{{ route('employee.email.view' ,$email->id ) }}">
