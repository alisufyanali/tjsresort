...
<div class="col-md-12">
    <div class="card table-card">
        <div class="card-header">
            ...
            <a href="{{ route('employee.email_settings.create') }}" class="btn btn-primary waves-effect"> Add New</a>
            @endif
            ...
            <table class="table table-bordered mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('employee.email_settings.edit', $data['settings']->id) }}" class="btn btn-warning">Edit</a>
                            <form action="{{ route('employee.email_settings.destroy', $data['settings']->id) }}" method="POST"
