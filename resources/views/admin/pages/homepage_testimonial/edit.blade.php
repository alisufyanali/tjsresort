...
<div class="col-md-12">
    <div class="card table-card">
        ...
        <div class="card-block p-b-0">
            ...
            <form action="{{ route('admin.homepage_testimonial.update', $testimonial->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="comment"
                        name="comment">{{ old('comment', $testimonial->comment) }}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="postion" name="postion"
                        value="{{ old('postion', $testimonial->postion) }}">
                </div>
                <div class="form-group">
