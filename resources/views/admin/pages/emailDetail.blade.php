                            ...
                            <div class="col-lg-12 col-xl-3">
                                <div class="user-body">
                                    <div class="p-20 text-center">
                                        <a href="{{ route('admin.email.compose') }}" class="btn btn-danger waves-effect">Compose</a>
                                    </div>
                                    <ul class="page-list nav nav-tabs flex-column" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item mail-section">
                                            <a class="nav-link waves-effect d-block" data-toggle="pill" href="{{ route('admin.email.draft') }}"
                                                role="tab">
                                                <i class="icofont icofont-file-text"></i> Drafts
                                            </a>
                                        </li>
                                        <li class="nav-item mail-section">
                                            <a class="nav-link waves-effect d-block" data-toggle="pill" href="{{ route('admin.email.sent') }}"
                                                role="tab">
                                                <i class="icofont icofont-paper-plane"></i> Sent Mail
                                            </a>
                                        </li>
                                        <li class="nav-item mail-section">
                                            <a class="nav-link waves-effect d-block" data-toggle="pill" href="{{ route('admin.email.trash') }}"
                                                role="tab">
                                        ...
                                        <div class="mail-body-content email-read">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>{{ $data['message']->getSubject() }}</h5>
                                                    <h6 class="float-end"> {{ \Carbon\Carbon::parse($data['message']->getDate())->format('Y-m-d H:i:s') }}</h6>
                                                </div>
                                                <div class="card-block">
                                                    <div class="d-flex m-b-20">
                                                        ...
                                                        <div class="flex-grow-1 photo-contant">
                                                            <a href="#">
                                                                <h6 class="user-name txt-primary">
                                                                @php
                                                                        // Extract the name part before the email address
                                                                        $name = explode('<', $data['message']->getFrom()[0]->full)[0];
                                                                        echo trim($name);
                                                                    @endphp
                                                                </h6>
                                                            </a>
                                                            <a class="user-mail txt-muted" href="#">
                                                                <h6>From:{{ $data['message']->getFrom()[0]->mail }} </h6>
                                                            </a>
                                                            <div>
                                                                
                                                                {!! nl2br(e($data['message']->getTextBody())) !!}
